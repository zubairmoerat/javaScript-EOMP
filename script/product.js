    ...
    if(products){
        products.forEach((product, i)=>{
            ...
            <div class="card-body">
              ...
              <a href="#" class="btn btn-secondary" id="cart" onclick='addToCart(${JSON.stringify(product)})'>Add To Cart</a>
            </div>
            </div>
            </div>
          `
    ...
    if(searchItem.length != 0){
        ...
        searchItem.forEach( item=>{
            ...
            <div class="card-body">
              ...
              <a href="#" class="btn btn-secondary" id="cart" onclick='addToCart(${JSON.stringify(item)})'>Add To Cart</a>
            </div>
            </div>
            </div>
            `
